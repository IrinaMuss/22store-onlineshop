...
***************************************************************************** */
    ...
    document.addEventListener("click", (function(e) {
        ...
        if (targetElement.closest(".size__item")) {
            targetElement.closest(".size__item").classList.toggle("active");
            e.preventDefault();
        } else {
        ...
        if (targetElement.classList.contains("item-header__cart") || targetElement.closest(".item-header__cart")) {
            if (document.querySelector(".cart-list").children.length > 0) document.querySelector(".item-header").classList.toggle("_active");
            e.preventDefault();
        } else if (!targetElement.closest(".item-header") && !targetElement.classList.contains("actions-product__button")) document.querySelector(".item-header").classList.remove("_active");
    ...
    function addToCart(productButton, productID) {
        if (!productButton.classList.contains("_hold")) {
            ...
            const cart = document.querySelector(".item-header__cart");
            const product = document.querySelector(`[data-pid="${productID}"]`);
            const productImage = product.querySelector(".card-product__image");
    ...
    function updateCart(productButton, productID, productAdd = true) {
        const cart = document.querySelector(".item-header");
        const cartIcon = cart.querySelector(".item-header__cart");
        ...
        if (productAdd) {
            ...
            if (!cartProduct) {
                const product = document.querySelector(`[data-pid="${productID}"]`);
                const cartProductImage = product.querySelector(".card-product__image").innerHTML;
